...
def main():
    ...
    parser.add_argument('--config', 
                        default="/maggie.meng/code/CRN/exps/det/fisheye_onnx_CRN_r50_512x768_128x128_4key_with_vel.py", 
                        help='Config file')
    parser.add_argument('--checkpoint', 
                        default="/maggie.meng/code/CRN/outputs_zongmu/det/CRN_r50_256x704_128x128_4key/lightning_logs/version_19_1.2k_fisheye_false/checkpoints/epoch=29-step=1110.ckpt", 
    ...
    parser.add_argument(
        '--outfile', 
        type=str, 
        default='/maggie.meng/code/CRN/outputs_zongmu/det/CRN_r50_256x704_128x128_4key/lightning_logs/version_19_1.2k_fisheye_false/checkpoints/', 
