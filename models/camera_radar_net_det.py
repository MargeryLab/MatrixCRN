...
from layers.backbones.pts_backbone import PtsBackbone, PtsBackboneCamCoords
...
__all__ = ['CameraRadarNetDet', 'CameraRadarMatrixVTNet']
    ...
    def forward(self,
        ...
        if is_train:
            ...
            feats, depth, _ = self.backbone_img(sweep_imgs,
                                                ...
                                                ptss_context,
                                                ptss_occupancy,
                                                return_depth=True) #(2,4,160,128,128), (12,70,16,44)
...
class CameraRadarMatrixVTNet(BaseBEVDepth):
    """Source code of `CRN`, `https://arxiv.org/abs/2304.00670`.
    ...
    def forward(self,
        ...
        if is_train:
            ...
            ptss_context, ptss_occupancy, _ = self.backbone_pts(sweep_ptss)
            feats, depth, _ = self.backbone_img(sweep_imgs, #(2,4,80,128,128)
                                                mats_dict,
                                                ptss_context,
                                                # ptss_occupancy,
